...
public class ElementUtil {
	...
	private void nullBlankCheck(String value) {
		if (value == null || value.length() == 0) {
			throw new ElementException(value + "----value text cannot be null or blank"); // create the object of the
																							// class and throw the
																							// exception
		}
	}
	...
	public WebElement getElement(By locator) {
		...
		try {
			...
			e.printStackTrace();
			return null; // can avoid/comment out this line if you want
		}
	...
	public WebElement getElement(String locatorType, String locatorValue) {
		...
		highlightElement(element); // can also right inside a catch block for if element is not found
		return element;
	}
